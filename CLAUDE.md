...
**YOU ARE IN: `claudemeter/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/claudemeter/` (rig root) or other directories
...
**Your mail address:** `claudemeter/polecats/rust`
**Your rig:** claudemeter
**Your Witness:** `claudemeter/witness`
...
| Ask Witness for help | `gt mail send claudemeter/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`claudemeter/witness`) when:
...
```bash
gt mail send claudemeter/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
